...
* Independent integer datapath:
	...
	- fp32:i32 rate:  1:1 - not supported, 2:1 - supported, only IADD. [my]
...
* SM bound to one or multiple render target regions with tile size 32x32 (or lower on high register usage)... [my]
...
* Only half2 fma (HFMA2) instruction has x2 rate comparing with float (FMA) - GLSL/SPIRV/Vulkan. [my]
